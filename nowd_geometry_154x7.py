...
# number of pixels in each direction - Gen1v2 Compatible
x_num2 = 154
y_num2 = 7
...
if __name__ == "__main__":
    inst_name = "NOWD"
    xml_outfile = f"{inst_name}_Definition_{x_num2}x{y_num2}.xml"
    ...
    for name in banks.keys():
        ...
        det = instr.makeDetectorElement('g2_lowres', root=col, extra_attrs=extra_attrs)
    ...
    det = instr.makeTypeElement("g2_lowres",
                                extra_attrs={"is":"rectangular_detector", "type":"pixel_g2_lowres",
    ...
    instr.addCuboidPixel("pixel_g2_lowres",
